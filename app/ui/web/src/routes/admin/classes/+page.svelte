<script lang="ts">
    ...
    return () => {
      ...
      return async ({ result, update }) => {
        ...
        if (result.type === "success") {
          ...
          showToast({
            message: result.data?.message || "Failed to create class.",
            type: "error",
          });
        }
      };
  ...
  let averageClassSize = $derived(
    totalClasses > 0 ? (totalStudentsEnrolled / totalClasses).toFixed(1) : 0,
  );
</script>
  ...
  <div class="mb-8">
    <h1 class="text-3xl font-bold flex items-center gap-3">
      <div class="rounded-lg bg-primary p-2">
        <svg
          class="h-8 w-8 z-10 text-primary-content"
          fill="none"
          viewBox="0 0 24 24"
          stroke="currentColor"
        >
    ...
    <p class="text-base-content/70 mt-2">
      Tạo và quản lý lớp học với giáo viên và học sinh.
    </p>
  </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
      <div class="stats shadow-lg border border-base-300">
        <div class="stat">
          ...
          <div class="stat-desc">Lớp đang hoạt động</div>
        </div>
      </div>
      ...
      <div class="stats shadow-lg border border-base-300">
        <div class="stat">
          ...
          <div class="stat-desc">Trong tất cả các lớp</div>
        </div>
      </div>
      ...
      <div class="stats shadow-lg border border-base-300">
        <div class="stat">
          ...
          <div class="stat-title">Sĩ số trung bình</div>
          <div class="stat-value text-accent">{averageClassSize}</div>
          <div class="stat-desc">Học sinh/lớp</div>
        </div>
      </div>
    </div>
  {/if}
          ...
          >
            <div class="form-control">
              <label for="name" class="label">
                <span class="label-text font-medium">Tên lớp</span>
              </label>
              <div class="relative">
                <span
            ...
            <div class="form-control">
              <label for="teacher_id" class="label">
                <span class="label-text font-medium">Phân công giáo viên</span>
              </label>
              <div class="relative">
                <span
        ...
        <div class="card-body">
          ...
          {#if data.classes.length === 0}
            <div class="alert">
              ...
              <div>
                <p class="font-medium">Chưa có lớp nào</p>
                <p class="text-sm opacity-80">
                  Tạo lớp đầu tiên bằng biểu mẫu bên cạnh.
                </p>
              </div>
            </div>
          {:else}
                    ...
                    {#if expanded.get(cls.id)}
                      <div class="mt-4 pt-4 border-t border-base-300">
                        <div class="flex items-center gap-2 mb-3">
                          ...
                          <h4 class="font-semibold">Danh sách học sinh</h4>
                        </div>
                        ...
                        {#if cls.students.length === 0}
                          <div class="alert alert-warning">
                            ...
                            <span class="text-sm"
                              >Chưa có học sinh trong lớp này.</span
                            >
                          </div>
                        {:else}
