...
<div class="container mx-auto p-8 max-w-7xl">
  ...
  <div class="mb-8">
    ...
    <p class="text-base-content/70 mt-2">
      Tạo và quản lý tài khoản giáo viên cho trường học.
    </p>
  </div>
      ...
      <div class="card bg-base-100 shadow-xl border border-base-300">
        <div class="card-body">
          ...
          >
            ...
            <div class="divider my-2 text-xs">Thông tin cá nhân</div>
        ...
        <div class="card-body">
          ...
          {#if data.teachers.length === 0}
            <div class="alert">
              ...
              <div>
                <p class="font-medium">Chưa có giáo viên nào</p>
                <p class="text-sm opacity-80">
                  Tạo tài khoản giáo viên đầu tiên bằng biểu mẫu bên cạnh.
                </p>
              </div>
            </div>
          {:else}
              ...
              <table class="table table-zebra">
                <thead>
                  <tr class="border-b-2 border-base-300">
                    ...
                    <th class="bg-base-200">Tên đăng nhập</th>
